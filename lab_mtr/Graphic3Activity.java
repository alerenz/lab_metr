...
public class Graphic3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graphic3);

        graph = findViewById(R.id.graph3);
        btnNext = findViewById(R.id.butNext4);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Graphic3Activity.this, FourthActivity.class);
    ...
    private void drawGraph(){
        ...
        for (Coordinates coord : coordinates) {
            minX = Math.min(minX, coord.getZ());
            maxX = Math.max(maxX, coord.getZ());
        }
        ...
        for (Coordinates coord : coordinates) {
            int binIndex = (int)((coord.getZ() - minX) / binWidth);
        ...
        probabilitySeries.setColor(Color.RED);
        ...
        graph.getGridLabelRenderer().setHorizontalAxisTitle("Значение Z");
